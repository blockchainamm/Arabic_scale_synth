# Program to generate the sounds of notes of an arabic scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a arabic scale
    notes_interval = [2, 2, 1, 1, 2, 2, 2, 2]
    rev_interval = [0, 2, 2, 2, 1, 1, 2, 2]
    tones_fwd, tones_rev = [], []
    
    print(f'The frequencies in Hz of ascending notes for {notescale} in the arabic scale')
    ...
    print()
    print(f'The frequencies in Hz of descending notes for {notescale} in the arabic scale')
    ...
    # Return list of frequencies in the ascending and descending notes of the arabic scale    
...
# Scale list for which the arabic scale will be played in sequence
scale_list = ['C4']
